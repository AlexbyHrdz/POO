...
public class EmpEscuela extends Academico {
    ...
    public EmpEscuela(double salario, String rol) {
        this.salario = salario;
        this.rol = rol;
    }

    public EmpEscuela(int id, String nombre, String apellido, String correo, String contraseña, String direccion, String telefono, double salario, String rol) {
